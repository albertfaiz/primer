...
class Recommendation:
    ...
    validation: Optional[Dict[str, Any]] = None   # measured CV result (Layer 6)
...
class PrimerReport:
    ...
    validated: bool = False                                  # did Layer 6 run?
    validation_summary: Optional[Dict[str, Any]] = None      # empirical decisiveness
